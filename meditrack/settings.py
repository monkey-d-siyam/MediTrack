...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-meditrack-dev-key-change-in-production-abc123xyz')
...
INSTALLED_APPS = [
    ...
    'health',  # Our health tracking app
]
...
# Attempt to configure database from DATABASE_URL env var (e.g., PostgreSQL natively via Render)
